...
INDEX `FK_fk_region_info_loh_house_info` (`region_info_id`) USING BTREE 
)
ENGINE=InnoDB
DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci
...
-- ----------------------------
ALTER TABLE `login_info` AUTO_INCREMENT=39;

-- ----------------------------
-- Auto increment value for `loh_file_info`
-- ----------------------------
ALTER TABLE `loh_file_info` AUTO_INCREMENT=18;
...
-- ----------------------------
ALTER TABLE `loh_house_info` AUTO_INCREMENT=105;

-- ----------------------------
-- Auto increment value for `loh_house_type`
-- ----------------------------
ALTER TABLE `loh_house_type` AUTO_INCREMENT=55;
...
-- ----------------------------
ALTER TABLE `user_info` AUTO_INCREMENT=41;
