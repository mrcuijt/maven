...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<form name="frmDeleteLohHouseInfoForm" method="post" action="<%=request.getContextPath()%>/loh/lease/deleteLohHouseInfo.do">
				<input name="id" type="text" value="${lohHouseInfo.lohHouseInfoId }" style="display:none;"/>
